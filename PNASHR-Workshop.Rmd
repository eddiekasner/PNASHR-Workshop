...
```{r nasem, echo=FALSE, out.width = '30%', fig.align="center"}
knitr::include_graphics("images/nasem-rr.jpg")
```
...
```{r regress_summary, echo = T}
summary(fit)
```

## Regression analysis: Plot

```{r regress_plot, echo = T, fig.height=4, fig.width=7}
par(mfrow=c(2,2))
plot(fit)
```
